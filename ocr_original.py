...
from onbid.extract_agency import is_cover_page_ocr, is_cover_page_pdf
...
def ocr_main(doc, orgFileName, originalSavePath, orgTimeStr, pdf_status, image_path_list, detectron_results, scale, uid):
    ...
    if all(status == Status.TEXT for status in pdf_status):
        ...
        return originalSavePath, cover_page_idx, summary_page_idx, detail_pages, None
    ...
    return result_pdf_path, cover_page_idx, summary_page_idx, detail_pages, None
